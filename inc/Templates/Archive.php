...
<span style="color: var(--chubes-accent-color-2);">GET</span>  /wp-json/chubes/v1/docs/<span style="color: var(--chubes-muted-text-color);">{id}</span>          <span style="color: var(--chubes-muted-text-color);">— returns markdown</span></code></pre>
